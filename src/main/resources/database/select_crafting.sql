...
SELECT ads.title, ads.short_description, ads.description, ads.price, ads.image, ads.dog_id, d.name, d.age, d.playfulness, d.socialization, d.affection, d.training, b.name, t.name, GROUP_CONCAT(DISTINCT b.name SEPARATOR ', ') AS breeds, GROUP_CONCAT(DISTINCT t.name SEPARATOR ', ') AS traits FROM ads JOIN dogs d ON d.id = ads.dog_id JOIN dog_breeds db ON d.id = db.dog_id JOIN breeds b ON b.id = db.breed_id JOIN dog_traits dt ON d.id = dt.dog_id JOIN traits t ON t.id = dt.trait_id WHERE b.name LIKE '%French%' OR t.name LIKE '%French%' OR ads.description LIKE '%French%' GROUP BY ads.title, ads.short_description, ads.description, ads.price, ads.image, ads.dog_id, d.name, d.age, d.playfulness, d.socialization, d.affection, d.training, b.name, t.name ORDER BY ads.dog_id asc;

SELECT ads.title, ads.short_description, ads.description, ads.price, ads.image, ads.dog_id, d.name, d.age, d.playfulness, d.socialization, d.affection, d.training, b.id, GROUP_CONCAT(DISTINCT b.name SEPARATOR ', ') AS breeds, GROUP_CONCAT(DISTINCT t.name SEPARATOR ', ') AS traits FROM ads JOIN dogs d ON d.id = ads.dog_id JOIN dog_breeds db ON d.id = db.dog_id JOIN breeds b ON b.id = db.breed_id JOIN dog_traits dt ON d.id = dt.dog_id JOIN traits t ON t.id = dt.trait_id WHERE b.name = 'French Bulldog' GROUP BY ads.title, ads.short_description, ads.description, ads.price, ads.image, ads.dog_id, d.name, d.age, d.playfulness, d.socialization, d.affection, d.training, b.id ORDER BY ads.dog_id asc
;

SELECT ads.title, ads.description, ads.short_description, ads.price, ads.image, ads.dog_id, d.name, d.age, d.playfulness, d.socialization, d.affection, d.training, t.id, t.name FROM ads JOIN dogs d ON d.id = ads.dog_id JOIN dog_traits dt ON d.id = dt.dog_id JOIN traits t ON t.id = dt.trait_id WHERE t.name IN ('Affectionate', 'Mischievous', 'Sociable') GROUP BY ads.title, ads.description, ads.short_description, ads.price, ads.image, ads.dog_id, d.name, d.age, d.playfulness, d.socialization, d.affection, d.training, t.id, t.name HAVING COUNT(DISTINCT t.name) = 3
;

SELECT ads.title, ads.short_description, ads.description, ads.price, ads.image, ads.dog_id, d.name, d.age, d.playfulness, d.socialization, d.affection, d.training, GROUP_CONCAT(DISTINCT b.name SEPARATOR ', ') AS breeds, GROUP_CONCAT(DISTINCT t.name SEPARATOR ', ') AS traits FROM ads JOIN dogs d ON d.id = ads.dog_id JOIN dog_breeds db ON d.id = db.dog_id JOIN breeds b ON b.id = db.breed_id JOIN dog_traits dt ON d.id = dt.dog_id JOIN traits t ON t.id = dt.trait_id WHERE t.name IN ('Affectionate', 'Independent', 'Sociable') GROUP BY ads.title, ads.short_description, ads.description, ads.price, ads.image, ads.dog_id, d.name, d.age, d.playfulness, d.socialization, d.affection, d.training HAVING COUNT(DISTINCT t.name) = 3 ORDER BY ads.dog_id asc
;